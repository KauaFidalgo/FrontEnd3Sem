...
export default function Produto() {
    //states e variáveis
    const [idProduto, setIdProduto] = useState(null)// usado no editar
    ...
    try {
        ...
        //listar os dados novamente
        if(retornoAPI.status == 200) {
            alert("Produto editado com sucesso")

            getProdutos()//lista os dados
            ...
            <form className="formzin" action="" onSubmit={editar ? editarProduto : cadastrarProduto}>
                ...
                {editar && <button
                    ...
                    onClick={() => {
                        ...
                        setIdProduto(null)//limpa o id do produto que estava sendo editado
                    ...
                    <div key={prod.id} className="produto">
                        ...
                        <a href=""
                            ...
                            onClick={(e) => {
                                ...
                                setEditar(true)//faz mostrar botao editar
